...
const Upload = () => {
    ...
    const uploadVideo = async (e: any) => {
        ...
        const fileTypes = ['video/mp4', 'video/webm', 'video/ogg', 'video/x-matroska']
        console.log("cek file type")
        console.log(selectedFile.type)
        if(fileTypes.includes(selectedFile.type)) {
            console.log("valid fieltype")
  ...
  return (
    ...
    pt-10 lg:pt-20 bg-[#F8F8F8] justify-center'>
        <div className='bg-white rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-between items-center
        p-14 pt-6 w-[60%]'>
            <div>
                <div>
                                ...
                                videoAsset ? (
                                    ...
                                    <label className='cursor-pointer'>
                                        ...
                                        <input 
                                            ...
                                            type="file" name="upload-video" id="" className='w-0 h-0'/>
                                    </label>
                                )
                            }
                        </div>
