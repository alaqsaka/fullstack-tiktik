    ...
    <div className='w-full flex justify-between items-center border-b-2 border-gray-200 px-4 py-2'>
      <Link href="/">
        <div className='w-[100px] md:w-[130px]'>
          <Image className='cursor-pointer' src={Logo} alt="TikTik Logo" layout='responsive'></Image>
        </div>
      </Link>

      <div className='relative hidden md:block'>
        <form action="" onSubmit={handleSearch} className="absolute md:static top-10 left-20 
        bg-white">
          <input 
            type="text"
            value={searchValue}
      ...
      <div>
        {userProfile ? (
          <div className='flex gap-5 md:gap-10'>
            <Link href="/upload">
              <button className='rounded border-2 px-2 md:px-4 text-md font-semibold flex items-center gap-2'>
